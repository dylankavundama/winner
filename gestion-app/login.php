...
<head>
    ...
    <style>
        ...
        .login-box {
            background: #fff; border-radius: 10px; box-shadow: 0 0 20px #0001; padding: 40px 30px; width: 100%; max-width: 400px;
        }
        .login-logo { display: block; margin: 0 auto 20px auto; max-width: 100px; }
    </style>
</head>
<body>
