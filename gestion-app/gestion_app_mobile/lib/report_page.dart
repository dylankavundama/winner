...
class _ReportPageState extends State<ReportPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchReports({String? customStart, String? customEnd}) async {
    ...
    try {
      final url = '${ApiConstants.baseUrl}/reports.php?start=${customStart ?? start}&end=${customEnd ?? end}';
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          setState(() {
            errorMessage = data['message'] ?? 'Erreur lors du chargement des rapports';
            isLoading = false;
          });
        }
      } else {
              ...
              Expanded(
                child: TextField(
                  ...
                  onTap: () async {
                    ...
                    if (picked != null) {
                      setState(() => start = DateFormat('yyyy-MM-dd').format(picked));
                      _fetchReports();
                    }
                  },
                ),
              ...
              Expanded(
                child: TextField(
                  ...
                  onTap: () async {
                    ...
                    if (picked != null) {
                      setState(() => end = DateFormat('yyyy-MM-dd').format(picked));
                      _fetchReports();
                    }
                  },
                ),
      ...
      child: sales.isEmpty
          ...
          : SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: sales.map<DataRow>((s) => DataRow(cells: [
      ...
      child: lowStock.isEmpty
          ...
          : SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: lowStock.map<DataRow>((p) => DataRow(cells: [
      ...
      child: topClients.isEmpty
          ...
          : SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: topClients.map<DataRow>((c) => DataRow(cells: [
      ...
      child: unpaid.isEmpty
          ...
          : SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: unpaid.map<DataRow>((f) => DataRow(cells: [
