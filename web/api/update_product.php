...
define('DB_NAME', 'winnerco_db'); // e.g., 'gestion_app_db'
define('DB_USER', 'winnerco_admin'); // e.g., 'root'
define('DB_PASSWORD', 'VY@LS?Z)_,V5'); // e.g., '' for no password, or 'mysecretpassword'
